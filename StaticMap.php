...
class StaticMap
{
    ...
    private readonly string $kmlFileName;
    private readonly string $gpxFileName;
    private readonly string $geojsonFileName;
    private readonly bool $autoZoomExtent;
    private readonly string $apikey;
    private readonly string $tileCacheBaseDir;
    private readonly string $mapCacheBaseDir;
    private readonly string $mediaBaseDir;
    private readonly bool $useTileCache;
